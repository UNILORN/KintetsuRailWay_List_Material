...
<!-- モーダルウインドウ -->
  ...
  <div id="modal-content">
    ...
    printCard("h","21020系 Urban Liner next",
    "名阪特急アーバンライナーは、昭和63年に運転を開始して以来、
    多くのお客様にご利用いただいてまいりましたが、平成14年に、
    進化型とも言うべき「アーバンライナー・ネクスト」21020系車両を新たに建造いたしました。"
    );
    ...
    printCard("i","5200系",
      "昭和63年、快適性を追求した急行兼団体用車両として5200系を製造しました。
      正面窓には曲面ガラスを採用し貫通扉の窓ガラスを縦長にして客室からの展望をよくしました。"
    );

    printCard("j","8810系",
      "昭和56年、奈良線に投入した最初の界磁チョッパ制御車が8810系です。
      4両4編成を製造し、続いて昭和57年には3編成を、昭和59年には1編成を各々追加しています。"
    );
